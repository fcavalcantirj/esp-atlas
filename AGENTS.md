...
data/
  ...
  firmware/<id>/firmware.md        # e.g. data/firmware/atom-watch/firmware.md
  firmware/<id>/signals.json       # Jr-owned evidence written by jr/stage_boardmap.py — never hand-edit (SPEC-firmware-boards §4)
  brands/, companions/             # vendor profiles, non-ESP companion radios
  board_universe.json              # GENERATED by scripts/build_board_universe.py — never hand-edit (SPEC-firmware-boards §2)
