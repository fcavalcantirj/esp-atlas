...
- Built-in USB-to-serial converter with auto-reset over Micro USB; bridge chip model
  not named on the product page (omitted)
...
- 'io.gpio_free=14 DERIVED, not quoted (SPEC-io-power.md §5.3). Pinouts page gives
  ...
  usb_flash_tied {7,8} (2) -- gives 20 - 6 = 14. Math not vendor-stated; verify before
  treating as exact.'
- 'io.power_out QUOTED: vendor page states "You can draw 500mA whether powered by
  USB or battery."'
download_mode:
  mode: auto
