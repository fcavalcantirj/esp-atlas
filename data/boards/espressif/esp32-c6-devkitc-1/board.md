...
- 'io.gpio_free=16 DERIVED, not quoted (SPEC-io-power.md §5.3). Header J1+J3 break
  out 23 pads total (quoted from the user guide pin tables: J1 = GPIO 0-8,10,11;
  J3 = GPIO 9,12,13,15-23). Subtracting esp32-c6''s soc.reserved_pins that are
  exposed -- strapping {8,9,10,11,15} (5) and usb_flash_tied {12,13} (2) -- gives
  23 - 5 - 2 = 16. Math not vendor-stated; verify before treating as exact.'
sources:
- field: '*'
