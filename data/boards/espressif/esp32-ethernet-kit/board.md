...
- FT2232H provides a USB-to-JTAG channel (channel A) and a USB-to-serial channel
  (channel B) over a single Micro-USB port
- Onboard Ethernet Link/Activity LEDs, a 4-bit DIP function switch, and BOOT/EN
  buttons
