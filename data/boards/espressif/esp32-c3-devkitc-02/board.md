...
- 'io.gpio_free=10 DERIVED, not quoted (SPEC-io-power.md §5.3). Headers J1+J3 break
  out 15 pads total (quoted from the user guide pin tables: J1 = GPIO 4-9; J3 = GPIO
  0-3,10,18-21). Subtracting esp32-c3''s soc.reserved_pins that are exposed -- strapping
...
getting_started: https://docs.espressif.com/projects/esp-dev-kits/en/latest/esp32c3/esp32-c3-devkitc-02/user_guide.html
sources:
- field: '*'
