...
power:
  ...
  charging: true
notes:
- 'Vendor repo README: "ESP32-S3-WROOM-1" with "16M / 8M" flash and PSRAM; display "ED047TC1 (4.7 inches, 960x540 , 16 gray)"; touch "GT911 (0x5D)"; battery "3.7V-1500mAh" with "BQ25896 (0x6B), BQ27220 (0x55)" charger and fuel gauge; TPS65185 e-ink PMIC; PCF8563 RTC; PCA9535PW GPIO expander'
- 'Three variants share the board: "T5 E-Paper S3 Pro" (GPS + LoRa SX1262 + TPS65185), "Pro Lite" (GPS and LoRa omitted, same schematic), "H752" (LoRa included, GPS and TPS65185 absent)'
