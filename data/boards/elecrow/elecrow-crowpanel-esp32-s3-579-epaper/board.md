...
- 'Display: 5.79-inch e-paper, "272(H)*792(L) Pixel", driver "SSD1683 x2", "3-/4-wire SPI, default 4-wire SPI"; active area "47.74 x 139.00 mm (H x L)"'
- '"BAT interface (SH1.0-2P connector)" supporting "2.2~3.7V"; charging circuit not detailed on the page (charging omitted); "TF Card Slot x1", "UART0 x1", "GPIO x1"; Rotary Switch, Menu, Back, Reset and BOOT buttons'
