...
- 'io.gpio_exposed=28 QUOTED: Heltec''s Wireless Tracker datasheet Pin Definition
  ...
  pads total, the same carrier layout as the sibling V3 boards; the SX1262''s SPI
  bus (GPIO8-11) and RST/DIO1/BUSY (GPIO12-14) are wired off-header directly to the
  radio'
- 'io.gpio_free=11 DERIVED: subtracting esp32-s3''s soc.reserved_pins that are exposed
  here (strapping {0,3,45,46}: all 4 present; usb_flash_tied {19,20,35,36,37}: all
  5 present -- 9 total), then the onboard ST7735S TFT and UC6580 GNSS pins per meshtastic''s
  heltec_wireless_tracker variant.h -- TFT (CS=38, DC=40, MOSI=42, SCK=41, RESET=39,
  backlight=21: 6 new pins) and GNSS (RX=33, TX=34, RESET=35, PPS=36; RESET/PPS are
