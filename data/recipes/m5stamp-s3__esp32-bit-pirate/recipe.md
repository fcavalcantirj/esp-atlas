...
flash:
  env: "cardputer-adv"
notes: "esp32-bit-pirate names this board as m5stack-stamps3 in its platformio.ini (env cardputer-adv); derived from the repo's own build files, not verified on hardware."
sources:
- field: '*'
